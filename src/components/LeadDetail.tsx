        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <GestionPanel
              ...
              onSaved={loadLeadData}
              leadData={{ ejecutivo_id: lead.ejecutivo_id, presupuesto_mensual: lead.presupuesto_mensual, urgencia: lead.urgencia, nombre_contacto: lead.nombre_contacto, telefono_principal: lead.telefono_principal }}
            />
